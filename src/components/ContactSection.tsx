...
export default function ContactSection() {
  return (
    <section id="contact" className="py-20 bg-gray-200/40 backdrop-blur-sm relative">
          ...
          <div className="space-y-6">
            ...
            <AnimatedSection animationType="fade-in-left" delay="300">
              <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-xl border border-white/20">
                <div>
                  <h4 className="font-bold text-black mb-2">이메일</h4>
                  <a 
            ...
            <AnimatedSection animationType="fade-in-left" delay="400">
              <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-xl border border-white/20">
                <div>
                  <h4 className="font-bold text-black mb-2">GitHub</h4>
                  <a 
            ...
            <AnimatedSection animationType="fade-in-left" delay="500">
              <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-xl border border-white/20">
                <div>
                  <h4 className="font-bold text-black mb-2">기타 링크</h4>
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-xl border border-white/20">
              ...
              <form className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-white text-black"
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold py-3 px-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300"
                >
                  메시지 보내기
                </button>
              </form>
